...
def generateVOC2Json(rootDir,xmlFiles):
  ...
  with open(r"D:\Harshil\AI\Model_Training\Table_data_307\data\coco\coco.json", "w") as f:
    f.write(jsonString)

# Path to the txt file (see at the top of this script)
trainFile = r"D:\Harshil\AI\Model_Training\Table_data_307\data\coco\coco.txt"
trainXMLFiles = list()
...
rootDir = r"D:\Harshil\AI\Model_Training\Table_data_307\data\coco\annotations"
