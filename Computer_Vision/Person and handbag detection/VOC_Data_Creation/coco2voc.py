...
src_base = r"D:\Harshil\My_work\ML\Projects\P_H_Object_detection"
dst_base = r"D:\Harshil\My_work\ML\Projects\P_H_Object_detection\VOC"
...
sets = {
    "trainval": os.path.join(src_base, r"D:\Harshil\My_work\ML\Data\COCO Json\annotations_trainval\instances_train2017.json"),
    "test": os.path.join(src_base, r"D:\Harshil\My_work\ML\Data\COCO Json\annotations_trainval\instances_val2017.json"),
}

cate = {x['id']: x['name'] for x in json.load(open(sets["test"]))['categories']}
# cate={1:'person',31:'handbag'}
# print(cate)
# print({x['id']: x['name'] for x in json.load(open(sets["test"]))['categories']})
